...
<body>
    ...
    <div>
        <div class="main-container">
            ...
            <form class="create-container" method="POST" action="{{ route('add-content') }}">
                @csrf
                ...
                <div class="content-card">
                    <div>内容：</div>
                    <textarea name="content" id="content-field"></textarea>
                </div>

                <div class="create-button" onclick="event.preventDefault();this.closest('form').submit();">
                    <div>新規作成</div>
                </div>
            </form>
